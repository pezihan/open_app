<template>
    <view class="content">
        <image class="background" src="../../static/login.jpg" mode="aspectFit"></image>
        <view class="content_item">
            ...
            <view class="login" @click="handleLogin"><button>登录</button></view>
        </view>
        <navigator url="/pages/set/index" open-type="navigate"  class="set">
            <button open-type="getPhoneNumber">接口设置</button>
        </navigator>
    </view>
</template>
